...
class InvalidTransactions
{
  ...
  private:
    ...
    bool IsTransactionAmountValid(const Transaction& transaction) const noexcept;
    bool IsTransactionAllowed(const Transaction& transaction) const noexcept;
    bool HasPreviousTransaction() const noexcept;

    Transaction previous_transaction_;
};
