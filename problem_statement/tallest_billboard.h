...
#ifndef PROBLEM_STATEMENT_TALLEST_BILLBOARD_H
#define PROBLEM_STATEMENT_TALLEST_BILLBOARD_H
...
{
  public:
    std::int32_t GetTallestBillboard(const std::vector<std::int32_t>& rods) { return rods.size(); }
};
}  // namespace problem_statement

#endif  /// PROBLEM_STATEMENT_TALLEST_BILLBOARD_H
