...
class BinaryExpressionBuilder
{
  ...
  public:
    class NotWellFormed : public std::exception
    {
      ...
      public:
        virtual const char* what() const throw() { return "The expression is not valid"; }
    };
...
//     $ g++ ExpressionTreeInfix.cpp $ a.out

//         Enter expression 2 +
//     3 * 5 result = 17 ------------------(program exited with code : 0)Press return to continue
